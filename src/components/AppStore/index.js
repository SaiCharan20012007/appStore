...
class AppStore extends Component {
  state = {searchValue: '', activeId: tabsList[0].tabId}
  ...
  render() {
    ...
    const finalList = appsList.filter(eachApp => eachApp.category === activeId)
    const filteredList = finalList.filter(eachApp =>
      ...
      <div className="bgContainer">
        ...
        <div className="searchBar">
          <input
            ...
            placeholder="Search"
            onChange={this.OnSearchFunction}
          />
          <img
        ...
        <div className="appSection">
          <ul className="appUL">
            {filteredList.map(eachApp => (
              <AppItem
                key={eachApp.appId}
                appName={eachApp.appName}
                imageUrl={eachApp.imageUrl}
                category={eachApp.category}
              />
            ))}
          </ul>
        </div>
